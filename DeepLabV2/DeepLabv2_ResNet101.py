...
Original file is located at
    https://colab.research.google.com/drive/18rs-ZPv1n0BKJu7JYXqris6W1v1RFl8l
"""
...
def train():
    ...
    start_epoch = 5  # Change to 0 to start without using checkpoints
