...
def main():
    ...
    # Dataloader per il dominio target (non annotato)
    ...
    # Ottimizzatore per il discriminatore
    optimizer_discriminator = torch.optim.Adam(discriminator.parameters(), lr=config.TRAIN.LR_DISCRIMINATOR)
    ...
    for epoch in range(last_epoch, real_end):
        ...
        train(config, epoch, config.TRAIN.END_EPOCH,
                ...
                model.module.model, discriminator,
                writer_dict)
