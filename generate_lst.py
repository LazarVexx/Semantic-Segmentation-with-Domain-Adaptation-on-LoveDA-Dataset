...
# Esempio di utilizzo
folder1 = 'PIDNet/data/loveDa/Val/Rural/images_png'  # Sostituisci con il percorso della prima cartella
folder2 = 'PIDNet/data/loveDa/Val/Rural/masks_png'  # Sostituisci con il percorso della seconda cartella
output = 'PIDNet/data/list/loveda/val.lst'  # Nome del file di output
